...
function MealCard({ meal }: { meal: Meal }) {
    ...
    return (
        <div className={clsx(
            ...
            isWarning ? "bg-red-50 border-red-200" : isMain ? "bg-white border-gray-200 shadow-sm" : "bg-gray-50 border-transparent"
        )}>
            {/* Left accent bar */}
            {!isWarning && (
                <div className={clsx(
            ...
            <div className="p-4 pl-6">
                <div className="flex justify-between items-start mb-2">
                    <span className="text-xs font-bold text-gray-400 uppercase tracking-widest">{meal.type.replace('_', ' ')}</span>
                    {!isWarning && (
                ...
                <div className="mb-3">
                    {isWarning ? (
                        <div className="text-red-600 font-bold">
                            ...
                            <p className="text-xs font-normal mt-1 text-red-500">
                                {meal.instructions[0]}
                            </p>
                        </div>
                    ) : (
                        <div className="space-y-1">
                            {meal.ingredients.map((ing, idx) => (
                                <div key={idx} className="flex justify-between items-center text-sm">
                                    ...
                                    <span className="text-gray-500 bg-gray-100 px-2 rounded-md text-xs py-0.5">
                ...
                {/* Macros */}
                {!isWarning && (
                    <div className="flex gap-4 text-xs pt-2 border-t border-gray-100 mt-2">
